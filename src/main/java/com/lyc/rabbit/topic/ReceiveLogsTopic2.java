...
//      绑定路由关键字
    ...
    /**
     * 输出
     ReceiveLogsTopic2 exchange:topic_logs, queue:amq.gen-1oTaxaKA6e-GYdhkCpEw9w, BindRoutingKey:*.*.rabbit
     ReceiveLogsTopic2 exchange:topic_logs, queue:amq.gen-1oTaxaKA6e-GYdhkCpEw9w, BindRoutingKey:lazy.#
